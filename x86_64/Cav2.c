...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "vtrap_Cav2", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_Cav2
...
#define hinf_Cav2 _thread[_gth]._pval[1]
#define mtau_Cav2_Cav2 _thread1data[2]
#define mtau_Cav2 _thread[_gth]._pval[2]
#define minf_Cav2_Cav2 _thread1data[3]
#define minf_Cav2 _thread[_gth]._pval[3]
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "g_Cav2_bar_Cav2", 0, 1e+09,
 0,0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 Cav2 /home/paulo/Documents/Estudos/Ciências/Ciências Naturais/Biologia/Neurociência/LASCON/lascon-project/channels/Cav2.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {int _reset = 0; {
   ...
   Dm_Cav2 = ( minf_Cav2 - m_Cav2 ) / mtau_Cav2 ;
   Dh_Cav2 = ( hinf_Cav2 - h_Cav2 ) / htau_Cav2 ;
   }
 return _reset;
}
 static int _ode_matsol1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {
 rates ( _threadargscomma_ v ) ;
 Dm_Cav2 = Dm_Cav2  / (1. - dt*( ( ( ( - 1.0 ) ) ) / mtau_Cav2 )) ;
 Dh_Cav2 = Dh_Cav2  / (1. - dt*( ( ( ( - 1.0 ) ) ) / htau_Cav2 )) ;
  return 0;
}
 /*END CVODE*/
 static int states (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) { {
   rates ( _threadargscomma_ v ) ;
    m_Cav2 = m_Cav2 + (1. - exp(dt*(( ( ( - 1.0 ) ) ) / mtau_Cav2)))*(- ( ( ( minf_Cav2 ) ) / mtau_Cav2 ) / ( ( ( ( - 1.0 ) ) ) / mtau_Cav2 ) - m_Cav2) ;
    h_Cav2 = h_Cav2 + (1. - exp(dt*(( ( ( - 1.0 ) ) ) / htau_Cav2)))*(- ( ( ( hinf_Cav2 ) ) / htau_Cav2 ) / ( ( ( ( - 1.0 ) ) ) / htau_Cav2 ) - h_Cav2) ;
   }
  return 0;
}
...
static void _initlists(){
 ...
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = m_Cav2_columnindex;  _dlist1[0] = Dm_Cav2_columnindex;
 _slist1[1] = h_Cav2_columnindex;  _dlist1[1] = Dh_Cav2_columnindex;
_first = 0;
}
